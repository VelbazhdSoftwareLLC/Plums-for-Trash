...
class DumpDeck extends Deck {
    ...
    DumpDeck() {
        ...
        CARDS = List.<Card>of(
                ...
                new PaperCard("garbage_cards_v6_14"),
                new PaperCard("garbage_cards_v6_15"),
                new PaperCard("garbage_cards_v6_16"),
                new PaperCard("garbage_cards_v6_17"),
                new PaperCard("garbage_cards_v6_18"),
                new PaperCard("garbage_cards_v6_19"),
                new PaperCard("garbage_cards_v6_20"),
                new PaperCard("garbage_cards_v6_21"),
                new PaperCard("garbage_cards_v6_22"),
                new PaperCard("garbage_cards_v6_23"),
                new PaperCard("garbage_cards_v6_24"),
                new PaperCard("garbage_cards_v6_25"),
